...
halfconeapex = (60/2*pi)/180; %Angle at Half Power in radiance
...
a= [a NumericIntegration_(NoObj  ,-7.5 ,7.5 ,-7.5 ,7.5            ,stepsize)];
b= [b NumericIntegration_(ObjTop ,-7.5 ,7.5 ,-7.5 ,7.5            ,stepsize)]; %human will only walk in the center of the sidewalk (tus between 0 and 2 m)
c= [c NumericIntegration_(ObjSide,-7.5 ,7.5 ,0  ,CarH+stepsize*10 ,stepsize)]; %object is never going to be in the ground and higher than CarH
d= [d NumericIntegration_(ObjBack,-2   ,2   ,0  ,CarH+0.5         ,stepsize)]; %object is never going to be in the ground and higher than CarH
