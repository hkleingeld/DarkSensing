...
EhorMeasured = 202%lx - Ehor @ 0.5m = place holder
Lightsensor_black = 19; %= place holder
...
a1 = dist(0.2,0.03,0)^2 * Lightsensor_black / (EhorMeasured*4*pi*0.0001 * phong(0.5,0.5,0.5,0,0,1,1,0))
