...
for Yloc = 0:0.2:0.6  %should always be 0 or bigger than 0.5 CarW for shaddows to work properly!
...
%plot result
hold on
plot(x,tot,'DisplayName',['\alpha = ' num2str(objRefl) ', y = ' num2str(Yloc) ')'])
end
