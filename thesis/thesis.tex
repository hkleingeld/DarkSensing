...
\newcommand{\reportDate}{12th December 2017}
\newcommand{\presentationDate}{19th December 2017}
\newcommand{\graduationCommittee}{
Prof. dr. K.G. Langendoen (Chair) & Delft University of Technology \\
dr. M. Zu\~{n}iga (Daily Supervisor) & Delft University of Technology \\
...
\newcommand{\reportKeywords}{Passive visible light localisation, Human activity detection}
...
\include{chapters/Flash_Analysis}
\include{chapters/Analyser}
\include{chapters/System_Evaluation}
