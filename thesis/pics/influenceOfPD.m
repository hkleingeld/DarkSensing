...
close
hold on
plot(t,Ton1(:,5),'LineWidth',2,'DisplayName','PD_1, I_1')
plot(t,Ton3(:,5),'LineWidth',2,'DisplayName','PD_2, I_1')
plot(t,Ton2(:,5),'LineWidth',2,'DisplayName','PD_3, I_1')
plot(t,Ton2_2(:,5),'LineWidth',2,'DisplayName','PD_3, I_3')
